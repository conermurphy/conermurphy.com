  ...
  return (
    ...
    >
      <NoScrollLink href={`/${postType}/${slug}`} passHref>
        <a className="group relative flex flex-col max-w-xs lg:max-w-sm cursor-pointer bg-secondaryBg dark:bg-secondaryBgDark rounded-md overflow-hidden h-full min-w-full sm:min-w-0">
          <article>

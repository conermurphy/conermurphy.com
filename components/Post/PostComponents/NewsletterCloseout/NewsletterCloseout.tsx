...
export default function NewsletterCloseout() {
  return (
    <>
      ...
      <p className="text-sm md:text-base mb-6 text-primaryTextDimmed dark:text-primaryTextDimmedDark opacity-100">
        If you have enjoyed this edition and want to see more of my content
        please consider checking out my various socials below:
      </p>
      <ul className="mb-6 md:mb-8 opacity-75 list-disc pl-4 text-sm md:text-base text-primaryTextDimmed dark:text-primaryTextDimmedDark opacity-100">
        <li>
          <a

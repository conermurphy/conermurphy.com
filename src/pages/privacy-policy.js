  ...
  return (
    <PrivacyPolicyContainer>
      ...
      <p>
        ...
        <button href="window.gaOptout()" type="button">
          please click here.
        </button>{' '}
      </p>
      <p>
      ...
      <ul>
        <li>
          <strong>conermurphy.com_ga=GA1.1.1065468216.1609791686:</strong> This cookie is automatically set by Google Analytics.
        </li>
        <li>
      ...
      <h2>Your Rights</h2>
      <p>
        You have the right to access, rectify, erase, restrict processing, object to processing, or export personal data you share with us.

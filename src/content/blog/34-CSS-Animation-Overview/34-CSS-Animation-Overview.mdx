...
image: ./css-animation-overview.png
published: true
canonical_url: ""
description: ""
---
...
CSS Animations are a way of animating elements in CSS without any external libraries or the use JS.
...
You can also mix and match from/to and percentages like so:
...
**Animation properties do not control the style of the animation! That happens with the [[Keyframes]]**
...
**Description:** 
Allows for control of the length of the animation to complete one cycle of the animation. Time given in either Seconds(s) or Milliseconds(ms).
...
**Description:**
Controls how the animation progresses through the keyframes by establishing accerelations curve.

...
Recently, while scrolling through Twitter, I came across a tweet from [Dan Spratling.](https://twitter.com/dan_spratling/) It got me thinking about why we should design components and not pages as traditionally done. Check out the tweet below.

<Tweet tweet="1401103660785049600" />

In this post, I want to cover why I think designing components is the best way to design and develop websites and how it can be beneficial.
...
By making individual components to reuse throughout our project, we reduce the amount of code we needed.

When developing components with this mindset, it pays to generalise the components so that the content within them can change as required but the design stays the same. This means you only need to write the component once and then can pass the content in as required.
...
![Figma Artboard of my website](./cm-website-figma-artboard.png)
...
![Components directory of my codebase](./cm-website-components.png)

By having all the components separated I cut down on the amount of code required on the individual pages. Below is the code used to generate the content from my home page.

![Home page code for my website](./cm-website-home-page-code.png)
...
By using this mindset we can spend more time planning out our design. This makes the journey from concept to finished product smoother and faster while maintaining quality and not compromising on our client's needs.

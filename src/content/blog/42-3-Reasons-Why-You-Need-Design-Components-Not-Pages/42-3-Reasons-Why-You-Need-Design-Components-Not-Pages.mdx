...
While designing my website I was constantly on the look out for opportunities to break design elements down into components and re-use them in other places. It was a great way to speed up the designing stage of the project while still creating a high quality product that was easy to follow when I was developing.

Below is the Figma artboard I used for designing my website showing the components I created and then reused throughout the design. The majority of the website is in some way reused or comes from a component. The only page that was largely bespoke was the home page but this even contained a lot of components from other locations such as the testimonial section which is one big component.

![Figma Artboard of my website](./cm-website-figma-artboard.png)

### Developing

When it came time to develop my website I put a large amount of time into creating the individual component files and breaking out the different sections and elements of the design into individual files that I could easily import and reuse whenever and wherever I needed to. This made the development process more efficent and the code base more understandable and readable.

Below is all of the components currently being used on my website.

![Components directory of my codebase](./cm-website-components.png)

By having all of the components broken down like this I can cut down on the amount of code required to create individual pages, here is the code used to generate the content from my home page.

![Home page code for my website](./cm-website-home-page-code.png)

As you can see by spending the extra time to design and develop individual components you can cut down on the work required to create individual pages on your website.

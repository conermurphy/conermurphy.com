...
import CodeBlock from '../../components/md/CodeBlock.astro'
...
<CodeBlock language="yaml" highlightedLines="" filePath="docker-compose.yml" icon="" code={`
version: "3.7"
...
<CodeBlock language="json" highlightedLines="" filePath="package.json" icon="" code={`
"scripts": {
...
<CodeBlock language="ts" highlightedLines="" filePath="vitest.config.ts" icon="ts" code={`
...
<CodeBlock language="js" highlightedLines="" filePath="./__tests__/global.setup.js" icon="js" code={`
  import {
    CreateTableCommand,
    DeleteTableCommand,
...
<CodeBlock language="ts" highlightedLines="" filePath="./__tests__/books/create-book.test.ts" icon="ts" code={`

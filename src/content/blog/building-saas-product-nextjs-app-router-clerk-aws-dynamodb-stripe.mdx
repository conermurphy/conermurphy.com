...
```tsx
META: './components/auth/SignUpForm.tsx':{ }
"use client";
...
```tsx
META: './components/auth/CodeForm.tsx':{ }
"use client";
...
```tsx
META: './app/sign-up/verify-email-address/page.tsx':{ }
...
```tsx
META: './components/auth/SignInForm.tsx':{ }
"use client";
...
```ts
META: './utils/db/get-current-user.ts':{ }
...
```ts
META: './utils/stripe/create-stripe-user-id.ts':{ }
import { UpdateCommand } from "@aws-sdk/lib-dynamodb";
...
```ts
META: './utils/stripe/create-checkout-session.ts':{ }
import Stripe from "stripe";
...
```ts
META: './utils/db/get-user-by-id.ts':{ }
import { GetCommand } from "@aws-sdk/lib-dynamodb";
import { db } from "@/config";
import { IGetCommandOutput, IUser } from "@/types";
...
```ts
META: './app/api/webhooks/stripe/route.ts':{ }
import { NextResponse } from "next/server";
import Stripe from "stripe";
import { UpdateCommand } from "@aws-sdk/lib-dynamodb";
import { IPlan } from "@/types";
...
```ts
META: './utils/stripe/create-customer-portal-session.ts':{ }
import Stripe from "stripe";
...
```tsx
META: './components/CustomerPortal.tsx':{ }
import getCurrentUser from "@/utils/db/get-current-user";

...
A large part of using JavaScript is dealing with booleans. This might be in conditional rendering or a if statement. But, regardles booleans are everywhere.
...
This means that any time we create a value, wether it be a function, an object or a variable decleration it will evaluate to true.

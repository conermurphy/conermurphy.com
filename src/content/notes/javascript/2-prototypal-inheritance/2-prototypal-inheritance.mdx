...
If you're interested in reading more about the above then I recommended checking out the [page on __proto__ on MDN here.](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/proto)
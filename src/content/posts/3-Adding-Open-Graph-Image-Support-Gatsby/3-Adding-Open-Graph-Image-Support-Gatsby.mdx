...
The final step for us to add Open Graph support to our blog posts is modifying our blog post template file which for me is *blogPost.js* but this is whatever file is responsible for creating
...
we assigned to the *image* variable.

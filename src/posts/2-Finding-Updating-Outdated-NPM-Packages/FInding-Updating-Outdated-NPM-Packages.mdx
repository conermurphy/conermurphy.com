...
This command will upgrade all of the version hints in the package.json allowing you to install the latest version of the package by running the command:

```
npm update
```

Now you should have all of the latest packages in your project and if you downloaded the project without thes node_modules folder make sure to run npm install before running to download

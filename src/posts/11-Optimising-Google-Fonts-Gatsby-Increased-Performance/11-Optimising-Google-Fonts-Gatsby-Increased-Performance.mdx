...
image: ./optimising-google-fonts-gatsby-increased-performance.png
id: 11
---
...
Sometimes, we can measure the impact of Google Fonts loading in seconds rather than milliseconds which in a world where your entire site and business can be penalised for slow load times, this is a majour issue.
...
![Google Fonts API Files Gif](/gifs/11-GoogleFontsAPI.gif)

...
export { default as getAllPostsSlugs } from './getAllPostsSlugs';
export { default as getHeadings } from './getHeadings';
export { default as getHeadingLink } from './getHeadingLink';

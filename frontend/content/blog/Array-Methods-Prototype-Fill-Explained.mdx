---
UUID: "9c6458e9-98d2-40f9-b972-764ac0435109"
title: "JavaScript Array Methods: Array.prototype.fill() Explained"
description: "The Array is one of the most important data types in JavaScript, here is everything you need to know about the Array method Array.prototype.fill()."
date: "2020-06-09"
topics: ["DEVELOPMENT", "JAVASCRIPT"]
slug: javascript-array-methods-prototype-fill-explained
image: /images/generic/coffee-pour.jpg
published: true
canonical_url: ""
imageLink: "https://unsplash.com/photos/jjM89aXfbZs"
---
...
1. _Required -_ **value:** This is the value we want to fill the target array with. It's worth mentioning that all values in the array or in the chosen section of the array will be this replaced with this value.
2. _Optional -_ **start:** The start index of the section to replace on the target array. _Default starts at 0_
3. _Optional -_ **end:** The end index of the section to replace on the target array. (The specified end index is not included in the replacement). _Default is array.length_
...
```jsx
[1, 2, 3, 4, 5, 6].fill(2, 0, -3); // === [1,2,3,4,5,6].fill(2,0,3) => [2,2,2,4,5,6]
```
...
- [#8: Array.prototype.fill()](/blog/javascript-array-methods-prototype-fill-explained)

---
UUID: "9c967737-590b-4acb-85d3-5d5854a319af"
...
```ts:[]:vitest.config.ts:TYPESCRIPT
...
```js:[]:./__tests__/global.setup.js:JAVASCRIPT
import {
  CreateTableCommand,
  DeleteTableCommand,
...
```ts:[]:./__tests__/books/create-book.test.ts:TYPESCRIPT

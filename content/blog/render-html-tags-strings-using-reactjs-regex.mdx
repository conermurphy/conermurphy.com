...
title: "Render HTML Tags Inside Strings Using Reactjs and Regex"
description: "Whether it's adding code tags to titles or something else, rendering HTML inside strings can be a helpful tool. Here's how to do it in ReactJS with Regex."
date: "2022-10-17"
topics: ["DEVELOPMENT", "JAVASCRIPT", "REACTJS", "TAILWINDCSS"]
slug: render-html-tags-inside-strings-using-reactjs-regex
...
![Blog post example](/images/blog/render-html-tags-strings-using-reactjs-regex/post-example.jpg)
